<?php
  ...
  if (isset($_POST['kullanici_id'])) {
    try {
       ...
       $bildirimler = $db->prepare("select * from bildirimler where bildirim_alici = :kullanici_id and bildirim_okundu = :bildirim_okundu order by bildirim_id desc");
       $bildirimler->execute(array(
         ":kullanici_id" => $kullanici_id,
         ":bildirim_okundu" => BILDIRIM_OKUNMADI
       ));
